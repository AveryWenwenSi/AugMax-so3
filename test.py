...
# 
parser.add_argument('--test_batch_size', '--tb', type=int, default=128)
...
if __name__ == '__main__':
    ...
    for i in range(40):
        # load model:
        print(5*i)
        ckpt = torch.load(os.path.join(args.save_root_path, 'AugMax_results', args.ckpt_path, 'latest_all_theta2{}.pth'.format(i*5)))  #'latest_all_theta210.pth')) # 
